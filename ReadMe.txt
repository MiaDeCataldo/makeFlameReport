How to use makeFlameReport.exe 

This program is designed to make a report from the eLabNext download format, and put into the requested 
format for the FLAME study. 
